...
const Profiles = ({ match }) => {
    ...
    return (
        <Layout title="نمایه کاربر" description="امکان ویرایش نمایه کاربری" className="container-fluid">
            <h2 className="mb-4">نمایه : {name}</h2><span>تاریخ عضویت:: {moment(createdAt).locale('fa').fromNow()}</span>
            <br/>
